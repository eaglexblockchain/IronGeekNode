...
using Eagle.IO.Json;
using Eagle.Network;
using Eagle.Network.Payloads;
using Eagle.Network.RPC;
...
namespace Eagle.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        protected override string Prompt => "eagle";
        public override string ServiceName => "EAGLE-CLI";
        ...
        private bool OnShowBenzCommand(string[] args)
        {
            if (Program.Wallet == null)
            {
                Console.WriteLine($"Please open a wallet");
        ...
        private void LevelDBBlockchain_ApplicationExecuted(object sender, ApplicationExecutedEventArgs e)
        {
            ...
            json["benz_consumed"] = e.BenzConsumed.ToString();
